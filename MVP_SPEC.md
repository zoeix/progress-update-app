...
建立一個本機網頁工具，讓使用者可以輸入專案進度，透過 Codex 依固定格式整理內容、檢查 PM 進度內容顆粒度，並在使用者確認後上傳到 ClickUp。

此工具的核心不是美化文字，而是協助 PM 檢查進度是否夠具體、可追蹤、可驗收。
...
12. Codex 回傳格式化進度、內容顆粒度評分、缺漏資訊與追問。
13. UI 顯示評分與待補充問題。
...
評分目的：幫助 PM 自我檢查進度是否完整、聚焦、可量化、容易被非技術讀者理解，並呈現後續影響。
